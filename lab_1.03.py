...
Respond to the following:
    ...
    2. How would you make the program print out "cats are really cool" instead? - change animal to 'cats'
...
Respond to the following questions:
    1. What output does this produce? - it says 'dogs' is not defined 
    2. Why does this happen? - it thinks that 'dogs' is a variable 
'''
print("this" + " " + "is" + " " +                       
    "a" + " " +                                             
    "sentence" + ".")